...
$max_file_size = 3000*1000; //aprox. 3MB
$url_path = ""; //URL and path to project (e.g. http://my-site.com/tools/picupload/)
	    ...
	    if ($_FILES['files']['error'][$f] == 0) {	           
			...
			elseif( ! in_array(pathinfo($name, PATHINFO_EXTENSION), $valid_formats) ){
	            ...
	            if(move_uploaded_file($_FILES["files"]["tmp_name"][$f], $path . $uniq_name)) {
                    ...
                    $urls = $urls."<br>".$url_path.$path.$uniq_name; 
	            }
	        }
	    }
	}
...
<body>
	<div class="wrap">
		...
		# success message
		if($count !=0){
			printf("<p class='status'>%d files added successfully! %s</p>\n", $count, $urls);
		}
		?>
		<p>Max file size 1000kb, Valid formats jpg, png, gif, zip, bmp</p>
		<br />
		<br />
